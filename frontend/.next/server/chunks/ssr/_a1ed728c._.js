...
;
;
function DashboardClient({ session, initialExpenses }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Failed to add expenses:${error.message}`);
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Network error. Please try again later.");
            console.error("Submit error:", error);
        }
    };
    const notify = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Expense added successfully", {
            position: "top-right",
            autoClose: 5000,
...
//# sourceMappingURL=_a1ed728c._.js.map