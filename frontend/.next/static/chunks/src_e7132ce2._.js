...
async function Dashboard() {
    ...
    if (!session) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])("/login");
    await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:5000"), "/api/expenses"), {
        headers: {
            Authorization: "Bearer ".concat(session === null || session === void 0 ? void 0 : (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.id)
        }
    });
    await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:5000"), "/api/auth/me"), {
        headers: {
            Authorization: "Bearer ".concat(session === null || session === void 0 ? void 0 : (_session_user1 = session.user) === null || _session_user1 === void 0 ? void 0 : _session_user1.id)
        }
    });
...
//# sourceMappingURL=src_e7132ce2._.js.map