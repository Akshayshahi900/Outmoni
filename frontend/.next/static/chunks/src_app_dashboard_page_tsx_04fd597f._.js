...
function Dashboard() {
    ...
    const handleSubmit = async (event)=>{
        ...
        const response = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.SERVER_URL, "/api/expenses"), {
            method: "POST",
            headers: {
...
_s(Dashboard, "xfj1mOuJ454hiBxMJppACk9mO30=");
_c = Dashboard;
var _c;
